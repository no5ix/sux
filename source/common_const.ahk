...
LANGUAGE_CONF_MAP := {"Donate": "捐赠! 让作者更有动力给sux加新功能! ^_^"
    ...
    ,"Window Mover is useful for multi monitor users, `n it will automatically move the new window to the monitor where the mouse is": "窗口移动器对多显示器用户很有用, 它将会自动移动新窗口到鼠标所在的显示器"
    ,"Window Mover": "窗口移动器"
    ,"Hot Corner": "触发角"
    ,"Feature Switch": "功能开关"
    ,"Theme": "主题"
