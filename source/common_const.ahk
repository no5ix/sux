...
LANGUAGE_CONF_MAP := {"Tips: ": "小技巧: "
    ...
    ,"- ClipboardPlus now supports files and pictures - Improve the ease of use of the configuration file. Now even if you don’t know the ahk language, you can easily configure a single keyboard operation or a series of operation sequences - Optimize the logic of checking for updates": "- 现在历史剪切板支持文件和图片了! - 提高配置文件的易用性, 现在即使不会ahk语言, 也能轻松配置单个键盘操作或者配一串操作序列 - 优化检查更新的逻辑"
